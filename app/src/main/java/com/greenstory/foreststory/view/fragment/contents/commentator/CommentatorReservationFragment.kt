...
class CommentatorReservationFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.txtCommentatorHashTag.text = hashTags
    }
...
//           최소 날짜를 현재 시각 이후로
    ...
    fun txtSelectLocation(view: View){
        ...
        val items = commentatorActivity.commentatorDto.mountain.toArray(arrayOfNulls<String>(commentatorActivity.commentatorDto.mountain.size))
        ...
        builder.setTitle("장소 선택하기")
            .setItems(items,
                DialogInterface.OnClickListener { dialog, which ->
                    ...
                    binding.txtSelectedLocation.text = commentatorActivity.commentatorDto.mountain[which]
                })
        // 다이얼로그를 띄워주기
        builder.show()
    }
